...
namespace HospitalRegistrationApp
{
    public class Ziyaret
    {
        ...
        public Ziyaret(int visit_id, int patient_id, string patient_name, int secretary_id, string secretary_name, int doctor_id, string doctor_name,  DateTime date, string reasons,string diagnosis, string notes)
        {
