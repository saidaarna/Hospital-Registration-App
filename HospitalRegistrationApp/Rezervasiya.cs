...
{
    public class Rezervasiya
    {
        public int id, slot;
        public KeyValuePair<int, string> patient, secretary;
        public DateTime visit_date, date;

        public Rezervasiya(int id, int patient_id,string patient_name,int secretary_id, string secretary_name,int slot, DateTime visit_date,DateTime date)
        {
            this.id = id;
